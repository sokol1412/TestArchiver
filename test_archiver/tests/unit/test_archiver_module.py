...
class TestTestItem(unittest.TestCase):
    ...
    def test_parent_suite(self):
        ...
        test_run = archiver.TestRun(
            self.archiver, "unittests", "never", "unittests", None, None
        )
...
class TestLogMessage(unittest.TestCase):
    ...
    def test_max_log_message_length_is_used(self):
        ...
        message.insert("Some log message")
        self.assertEqual(
            self.mock_db.insert.mock_calls[0].args[1]["message"], "Some log m"
        )
        ...
        message.insert("Some log message")
        self.assertEqual(
            self.mock_db.insert.mock_calls[1].args[1]["message"], "og message"
        )
        ...
        message.insert("Some log message")
        self.assertEqual(
            self.mock_db.insert.mock_calls[2].args[1]["message"], "Some log message"
        )
        ...
        message.insert("Some log message")
        self.assertEqual(
            self.mock_db.insert.mock_calls[3].args[1]["message"], "Some log message"
        )
